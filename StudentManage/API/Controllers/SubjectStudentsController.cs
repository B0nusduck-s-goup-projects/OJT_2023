...
namespace API.Controllers
{
    ...
    public class SubjectStudentsController : Controller
    {
        ...
        public SubjectStudentsController(ISubjectStudentService subjectStudentService,
        ...
        {
            if (!_subjectStudentService.Get().Any())
            {
                return NotFound("The subject list is empty!");
            }
            return Ok(_subjectStudentService.Get());
        }
        ...
        public ActionResult<SubjectStudentDTO> GetById(int subjectId, int studentId)
        {
            ...
            var result = _subjectStudentService.Get(subjectId, studentId);
            if (result == null)
            {
        ...
        public ActionResult<List<SubjectStudentDTO>> GetByStudent(int id)
        {
            ...
            var result = _subjectStudentService.GetByStudent(id);
            if (result == null || result.Count <= 0)
            {
                return NotFound("Student with ID " + id + " exists, but student score are not found.");
            }

            return Ok(_subjectStudentService.GetByStudent(id));
        }
        ...
        public ActionResult<List<SubjectStudentDTO>> GetBySubject(int id)
        {
            ...
            var result = _subjectStudentService.GetBySubject(id);
            if (result == null || result.Count <= 0)
            {
                return NotFound("There are no score of any student learning subject: " + id);
            }

            return Ok(_subjectStudentService.GetBySubject(id));
        }
        ...
        public ActionResult<List<SubjectStudentDTO>> GetPage(int pageNum, int pageLength)
        {
            ...
            List<SubjectStudentDTO> page = _subjectStudentService.GetPage(pageNum, pageLength);
        ...
        public ActionResult<SubjectStudentDTO> Post(SubjectStudentDTO subject)
        {
            ...
            ActionStatusDTO result = _subjectStudentService.Post(subject);
        ...
        public ActionResult Put(SubjectStudentDTO subject)
        {
            ...
            _subjectStudentService.Put(subject);
            return NoContent();
        }
        ...
        {
            var delete404 = _subjectStudentService.Delete(subjectId, studentId);
            if (subjectId <= 0)
            {
                return BadRequest("SubjectId must be greater than 0.");
            }
            ...
            _subjectStudentService.Delete(subjectId, studentId);
            return NoContent();
        }
    }
}
