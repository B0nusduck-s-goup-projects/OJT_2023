...
namespace API.Controllers
{
    ...
    public class StudentContactsController : Controller
    {
        ...
        public StudentContactsController(IStudentContactService studentContactService, IStudentService studentService)
        {
        ...
        {
            if (!_studentContactService.Get().Any())
            {
                return NotFound("The student list is empty!");
            }
            return Ok(_studentContactService.Get());
        }
        ...
        public ActionResult<StudentContactDTO> GetByUser(int id)
        {
            ...
            StudentContactDTO? students = _studentContactService.GetByUser(id);
            if (students == null)
            {
        ...
        public ActionResult<StudentContactDTO> GetById(int id)
        {
            ...
            StudentContactDTO? students = _studentContactService.Get(id);
            if (students == null)
            {
                return NotFound("There is no student with id: " + id);
            }
            return Ok(_studentContactService.Get(id));
        }
        ...
        public ActionResult<List<StudentContactDTO>> GetPage(int pageNum, int pageLength)
        {
            ...
            List<StudentContactDTO> students = _studentContactService.Get(pageNum, pageLength);
        ...
        public ActionResult<StudentContactDTO> Post([FromBody] StudentContactDTO studentContact)
        {
            ...
            ActionStatusDTO result = _studentContactService.Post(studentContact);
        ...
        public ActionResult Put([FromBody] StudentContactDTO studentContact)
        {
            ...
            _studentContactService.Put(studentContact);
            return NoContent();
        }
        ...
        public ActionResult Delete(int id)
        {
            ...
            _studentContactService.Delete(id);
            return NoContent();
        }
    }
}
